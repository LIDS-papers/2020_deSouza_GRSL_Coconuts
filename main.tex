...
\begin{figure}[!t]
  \centering
  \subfloat[Groups of three classes centered on the origin.\label{fig:ex-groups}]
  {\includegraphics[width=.45\linewidth]{figures/example_groups/groups_centered}}
  ~
  \subfloat[Groups after applying convolution and activation operations. \label{fig:ex-groups-after}]{\includegraphics[width=.45\linewidth]{figures/example_groups/groups3d_centered}
  }
...
\section{Experiments}
We use a dataset formed from patches of coconut images. The dataset consists of images of dimensions $90 \times 90$ of coconut and non-coconut. The latter class has a large variability. The problem of interest is to classify the images in one of the two classes.
