...
\begin{figure*}
  \begin{center}
    ...
    %images----------------------------
     ...
     \node (img2) [image, below left=-5em of img1] {\includegraphics[width=.08\textwidth]{figures/qualitative/ours/lower-non_coco-105.png}};
     \node (img3) [image, below left=-5em of img2] {\includegraphics[width=.08\textwidth]{figures/qualitative/vgg/lower-coco-2212.png}};
     \node (img4) [image, below left=-5em of img3] {\includegraphics[width=.08\textwidth]{figures/qualitative/ours/upper-coco-108.png}};
    ...
    %images----------------------------
    \node (simg1) [image, above right=-2.5em and 3.4em of select] {\includegraphics[width=.08\textwidth]{figures/img4.png}};
    ...
    \node (simg4) [image, below left=-5em of simg3] {\includegraphics[width=.08\textwidth]{figures/img1.png}};
    ...
    %----------------------------------
     ...
     %images----------------------------
    \node (mimg1) [image, above right=-2.5em and 3.4em of put] {\includegraphics[width=.08\textwidth]{figures/markers4.png}};
    ...
    \node (mimg4) [image, below left=-5em of mimg3] {\includegraphics[width=.08\textwidth]{figures/markers1.png}};
    ...
    \node (user) [image, below=1.9em of simgs, outer sep = -.5em, label = {[label distance = 0.3em]below:{User}}] {\includegraphics[width=.07\textwidth]{figures/user.png}};
