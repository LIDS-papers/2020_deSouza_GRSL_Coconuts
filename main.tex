...
%(img3.west) -- (img1.north) node [black,midway,xshift=0.8cm, label = {[label distance = 0.1em]above:{Images}}] {};
    ...
    \end{tikzpicture}
  \end{center}
  \caption{Pipeline for training a feature extractor.}
...
\begin{table}[!t]
  ...
  \hline\hline
    ...
    CL+MLP & $0.822 \pm 0.011$ & $0.805 \pm 0.013$ & $0.811 \pm 0.012 $ \\
...
\begin{table}[!t]
    \begin{center}
        \begin{tabular}{|l|c|c|c|}
            ...
            Method & Precision & Recall & F-score \\
            \hline\hline
            FLIM+SVM (4) & $0.856 \pm 0.011 $ & $ 0.831 \pm 0.019$ & $ 0.838 \pm 0.017$\\
            FLIM+SVM (8) & $0.857 \pm 0.005$ & $0.838 \pm 0.010$ & $0.844 \pm 0.009$\\
            \hline
        \end{tabular}
    \end{center}
