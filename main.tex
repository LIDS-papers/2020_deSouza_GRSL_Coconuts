...
\title{Learning CNN filters from user-drawn image \textcolor{red}{markers} for coconut-tree image classification}
...
\begin{figure*}
  \begin{center}
    ...
    %----------------------------------
     ...
     %images----------------------------
    \node (mimg1) [image, above right=-2.5em and 2.8em of put] {\includegraphics[width=.08\textwidth]{figures/markers1.png}};
...
(img3.north west) -- (img1.north west) node [black,midway,xshift=-0.4cm, yshift=0.4cm, rotate=45] {\small 200};
...
\item FLIM+MLP: Image classification is performed by \textcolor{red}{Multi-Layer Perceptron} (MLP) from FLIM-based features.  
